...
<html>
  ...
  <div class = "container-fluid">
      <div class = "center">
            <form action="register.php" class = "ecellSignup" method = "post">
                  ...
                  <div class = "row">
                        <div class="col-xs-12">
                              ...
                              <input type="date" name="dob" min="1979-12-31"  class = "ecellInput" required>
                        </div>
                  </div>
                  ...
                  <input type="submit" value="Register" class = "btn btn-block submitBtn">
      </form>
      </div>
  </div>
  </body>
